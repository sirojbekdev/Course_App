    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomFieldMappers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomFieldMappers_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomFieldMapperId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionCustomFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionCustomFields_CustomFieldMappers_CustomFieldMapperId",
                        column: x => x.CustomFieldMapperId,
                        principalTable: "CustomFieldMappers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemCustomFields", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionCustomFields_CustomFieldMapperId",
                table: "CollectionCustomFields",
                column: "CustomFieldMapperId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldMappers_CollectionId",
                table: "CustomFieldMappers",
                column: "CollectionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItemCustomFields_ItemId",
